...
const compileJavaCode = async (req: NextApiRequest, res: NextApiResponse) => {
    const { code = "", input = "" } = JSON.parse(req.body);
    let url = "https://online-compiler-hwqk.onrender.com/api/java";
...
export default compileJavaCode;
